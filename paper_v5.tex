...
\begin{abstract}
    ...
    is a factor of a few faster than existing algorithms for small problems ($N_{\rm obs}\lesssim 10$ observations) and
...
$V$ surface in $\theta_2$ admits up to $6H{-}1$ stationary points
