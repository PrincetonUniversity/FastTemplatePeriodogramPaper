...
mean null maximum rises from $0.408$ at $H=1$ to $0.440$ at $H=3$, then
$0.443$ at both $H=6$ and $H=12$, and the empirical ${\rm FAP}=0.01$
threshold rises from $0.535$ ($H=1$) to $0.551$, $0.551$, and $0.553$ at
$H=3$, $6$, and $12$.  An $H=12$ template therefore costs less than $+0.02$
in detection threshold at fixed false-alarm probability relative to
...
$2.4$.  This measured extra-trials cost is the right
yardstick for the small, non-monotonic wobble of period-recovery rate with
vocabulary size in the sparse-sampling recovery simulations (RRab-dominated
universe; $768$ pooled sources per cell): the pooled rate at
$K = 1$, $2$, $4$, $8$ is $0.716$, $0.715$, $0.738$, $0.741$, with Wilson
$95\%$ intervals $[0.683, 0.747]$, $[0.682, 0.746]$, $[0.706, 0.768]$,
$[0.709, 0.771]$ -- a non-monotone range of $0.026$ with overlapping
intervals, comparable to the extra-trials penalty and therefore not
