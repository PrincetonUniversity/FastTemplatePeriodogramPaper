...
$\sim\!40$--$50$), so single-source shape information is already sufficient and
...
conditional entropy \citep{Graham_etal_2013}, with all six methods between
...
conditional-entropy rates to $58/58 = 100\%$ on science and $72/73$ overall
...
alias classification: with ${\gtrsim}250$ epochs over ${\geq}4.9$\,yr the ZTF
...
multi-band LS      & $100\%$ $[93.8,100]$ & $83.3\%$ $[55.2,95.3]$ & $97.3\%$ $[90.6,99.2]$ \\
GLS (single band)  & $98.3\%$ $[90.9,99.7]$ & $91.7\%$ $[64.6,98.5]$ & $97.3\%$ $[90.6,99.2]$ \\
...
brightness (Chen catalogs $134$ of the $958$ Gaia RR\,Lyrae there).
...
and conditional entropy \citep{Graham_etal_2013} is presented in
