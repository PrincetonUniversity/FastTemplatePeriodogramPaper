...
\correspondingauthor{John Hoffman}
\email{jah5@princeton.edu}

\author[0000-0003-3770-5541]{J.~A. Hoffman}
\affiliation{Department of Astrophysical Sciences, Princeton University, Princeton NJ 08540}

\author[0000-0002-9623-3401]{J.~T. VanderPlas}
\affiliation{eScience Institute, University of Washington, Seattle, WA 98195}
...
\begin{figure*}
    \centering
    \includegraphics[width=\textwidth]{correlation_with_large_H.pdf}
...
However, for reasonable cases ($N_f \lesssim 10^{50}$ when $H=5$)\footnote{Since the trigonometric sums take $\sim 5\%$ of the time when $N_f\sim 10^6$, the trigonometric sums should take 50\% of the time when $(0.05/0.95)\times(\log(HN_f) / \log(H\times 10^6)) = 1$ which occurs when $N_f\sim 10^{50}$}) the computation time is dominated by
...
%\begin{figure}
%\centering
%\includegraphics[width=0.5\textwidth]{timing_for_various_surveys.png}
