...
utilizing the non-equispaced fast Fourier transform \citep[][NFFT]{NFFT_KJD2009,NFFT_DR1993} to evaluate frequency-dependent
...
The multi-harmonic LS periodogram \citep[][MHGLS]{Bretthorst_1988,Schwarzenberg-Czerny_1996,Palmer_2009}, provides a more
...
may mitigate overfitting in the MHLS model \citep{Vanderplas+Ivezic_2015},
...
The second, as pointed out in \cite{Leroy_2012}, is to use the non-equispaced FFT \citep[][NFFT]{NFFT_KJD2009,NFFT_DR1993} 
...
In order to evaluate the accuracy and speed of the template periodogram, we have included slower alternative solvers within the Python implementation of the FTP that employ non-linear optimization.
